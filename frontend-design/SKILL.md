...
- **Typography**: Choose fonts that are beautiful, unique, and interesting. Avoid generic fonts like Arial and Inter; opt instead for distinctive choices that elevate the frontend's aesthetics. Use unexpected, characterful font choices. Pair a distinctive display font with a refined body font.
...
- **Production Quality**: Code that actually works, is well-structured, and performs well. Details matter: proper error handling, accessibility, responsive design.
...
Always prioritize visual distinctiveness and production-quality code over generic templates.
